...
public class githubapi {
    ...
    @BeforeClass
    public void setup() {
         SSHKey="ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHdLb0fxjO9MVT5KwBG9FKEosFDjTQdCycZcnWuCgZhG";

        reqspec = new RequestSpecBuilder().setBaseUri("https://api.github.com")
                .setContentType(ContentType.JSON).
                addHeader("Authorization","token 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").build();
